...
<div class="respond">
  ...
  <form class="commentform" name="commentform" action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post">
    ...
    <?php else : ?><p>你已登录：<a href="<?php echo get_option('siteurl'); ?>/wp-admin/profile.php"><?php echo $user_identity; ?></a>，<a href="<?php echo wp_logout_url(get_permalink()); ?>" title="退出登录">退出登录</a></p>
