    <footer class="footer" role="contentinfo">
      <div class="footer-content">
        ...
        <section class="copyright">
          ...
          <p>&copy; <?php echo date('Y'); ?> <a href="<?php bloginfo('url'); ?>" target="_blank"><?php bloginfo('name'); ?></a> · 采用 <a href="https://github.com/bizhongbio/bizhongbio" target="_blank">Bizhongbio</a> 主题 · <a href="<?php bloginfo('url'); ?>/sitemap.html" target="_blank">网站地图</a></p>
        </section>
      </div>
