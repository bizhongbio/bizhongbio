        ...
        <div class="content">
            <?php while(have_posts()) : the_post(); ?><article id="article">
                ...
                <section class="article-copyright">
                    <p>感谢你的阅读，本文版权归 <a href="<?php bloginfo('url'); ?>"><?php bloginfo('name'); ?> </a> 所有，转载时请注明出处。<br/>注明出处格式：<?php bloginfo('name'); ?>（<a title="<?php the_title(); ?>" href="<?php the_permalink(); ?>"><?php the_permalink(); ?></a>）</p>
                </section>
                ...
                <section class="article-related">
                    ...
                    <?php
                        ...
                        if($posttags){
                            ...
                            }if($i  == 0)echo '<p>暂无相关文章</p>'; ?><li class="clear"></li>
                        </ul>
                </section>
